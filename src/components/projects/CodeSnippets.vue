<template>
	<div>
		...
		<div class='responsive'>
			...
			<h4>Problem</h4>
			<styled-image :src='buildURL("codesnippets/3vs1.png")' alt='Combine three nodes into one' />
			...
			<h4>Research</h4>
			<styled-image :src='buildURL("codesnippets/code-versus.png")' alt='Use of space in the String Manipulation interface' />
			...
			<h4>Concept</h4>
			<styled-image :src='buildURL("codesnippets/variations-codesnippets.png")' alt='Two concepts for the code editor: Columns, variables and functions in dropdowns (left) or in a tabbed interface (right)' />
			...
			<h4>Evaluation</h4>
			<styled-image :src='buildURL("codesnippets/concept.png")' alt='Final UI concept' />
			...
			<styled-image :src='buildURL("codesnippets/column_expressions.png")' alt='User interface as of KNIME Analytics Platform v3.7.1' />
		</div>
