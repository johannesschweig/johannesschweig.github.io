<template>
	<div>
		...
		<div class='responsive'>
			...
			<h2>Research</h2>
			<styled-image :src='require("../../assets/codesnippets/code-versus.png")' alt='Use of space in the String Manipulation interface'></styled-image>
			...
			<h2>Concept</h2>
			<styled-image :src='require("../../assets/codesnippets/variations-codesnippets.png")' alt='Two concepts for the code editor: Columns, variables and functions in dropdowns (left) or in a tabbed interface (right)'></styled-image>
			...
			<h2>Evaluation</h2>
			<styled-image :src='require("../../assets/codesnippets/concept.png")' alt='Final UI concept'></styled-image>
			<p>The overall reception was positive. Forum users as well as colleagues gave very enthusiastic feedback on the new functionality.</p>
			<p>Feedback from a forum user: "Just want to say, THANKS. The new Column Expressions Node is a winner. Greatly increases productivity and workflow readability. Keep these types of nodes coming!" - <a href='https://forum.knime.com/t/column-expressions-is-another-winner-node-knime-3-6/11565'>clac2188</a></p>
			...
			<styled-image :src='require("../../assets/codesnippets/column_expressions.png")' alt='User interface as of KNIME Analytics Platform v3.7.1'></styled-image>
		</div>
